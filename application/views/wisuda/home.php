...
<script>
    $('#stok').highcharts({
        ...
        title: {
            text: 'Grafik Statistik Lulusan Semua Prodi Tahun <?php echo date("Y"); ?>'
        },
        xAxis: {
            categories: <?php echo json_encode($count['name']); ?>,
            crosshair: true
        },
        yAxis: {
            min: 0,
        ...
        tooltip: {
            ...
            pointFormat: '<tr><td style="color:{series.color};padding:0">{series.name}: </td>' +
                '<td style="padding:0"><b>{point.y} wisudawan/ti</b></td></tr>',
            footerFormat: '</table>',
            shared: true,
            useHTML: true
        },
        ...
        series: [{
            name: 'Jumlah',
            colorByPoint: true,
            data: <?php echo json_encode($count['data']); ?>
        }]
    });
</script>