...
if ($first_uri == "page") {
    $data = "active";
    $sub_page = "active";
} elseif ($first_uri == "log") {
    $data = "active";
    $sub_log = "active";
}
// if (($first_uri == "page") && ($second_uri == "add")) {
//     $sub_page = "active";
// }
...
<ul class="sidebar-menu">
    ...
    <li class="treeview <?php echo $data; ?>">
        ...
        <ul class="treeview-menu">
            ...
            <?php if (in_array('log', $ha)) : ?>
                <li class="<?php echo $sub_log; ?>">
                    <a href="<?php echo site_url($uriKu . 'log'); ?>"><i class="fa fa-circle-o"></i> Log activity</a>
                </li>
            <?php endif; ?>
        </ul>
    </li>
