...
<body>
  <div id="main-content">
    ...
    <h4>LAPORAN DATA RETUR BARANG</h4>
    <h4><?php echo ($this->session->userdata('tanggal_return')) ? $this->session->userdata('tanggal_return') : date('Y-m-01') . " - " . date('Y-m-d'); ?></h4>
    <table class="table" border="" cellpadding="10" cellspacing="0">
      <thead>
        <tr>
          ...
          <th width="10%">Jumlah Permintaan Produksi</th>
        ...
        if ($return) :
          foreach ($return as $row) : ?>
            <tr>
              ...
              <td class="ctr"><?php echo $row['jpp']; ?></td>
