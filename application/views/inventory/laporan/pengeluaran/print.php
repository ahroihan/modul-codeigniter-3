...
<body>
  <div id="main-content">
    ...
    <h4>LAPORAN DATA PENGELUARAN BARANG</h4>
    <h4><?php echo ($this->session->userdata('tanggal_pengeluaran')) ? $this->session->userdata('tanggal_pengeluaran') : date('Y-m-01') . " - " . date('Y-m-d'); ?></h4>
