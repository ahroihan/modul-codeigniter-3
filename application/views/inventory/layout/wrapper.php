...
<body class="hold-transition skin-green sidebar-mini">
    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <?php if ($this->session->flashdata('main_notification')) : ?>
                    <div class="alert" style="display: contents;">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                        <span style="color: red;font-weight: 700;font-size: xx-large;"><?php echo $this->session->flashdata('main_notification'); ?></span>
                    </div>
                <?php endif; ?>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url('assets/img/upload/' . $this->session->userdata('foto')); ?>" class="user-image" alt="User Image" onerror="imgError(this);">
                                <span class="hidden-xs"><?php echo $this->session->userdata('nama') ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    <img src="<?php echo base_url('assets/img/upload/' . $this->session->userdata('foto')); ?>" class="img-circle" alt="User Image" onerror="imgError(this);">
                                    <p>
    ...
    <script>
        function imgError(image) {
            image.onerror = "";
            image.src = "<?php echo base_url('assets/img/upload/logo_transparent.png'); ?>";
            return true;
        }
        $(function() {
