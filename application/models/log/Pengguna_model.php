...
class Pengguna_model extends CI_Model
{
    ...
    {
        $this->db->select('log_akses.akses, log_pengguna.*');
        $this->db->order_by("nama", "ASC");
        $this->db->join("log_akses", "log_pengguna.id_akses = log_akses.id", 'left');
    ...
    {
        $this->db->where('log_pengguna.id', $id);
        $this->db->join("log_akses", "log_pengguna.id_akses = log_akses.id", 'left');
